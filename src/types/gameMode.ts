export type GameMode = '5x5' | '6x6' | '7x7' | 'chengyu' | '成语';
...
export const GAME_MODES: Record<GameMode, GameModeConfig> = {
  ...
  'chengyu': {
    ...
    solutionSize: 8,
    displayName: '成语模式',
    description: 'Chinese idiom puzzles',
    urlPath: '/chengyu'
  },
  '成语': { // alias for 'chengyu'
    mode: '成语',
    solutionSize: 8,
    displayName: '成语模式',
    description: 'Chinese idiom puzzles',
...
export const GAME_MODE_LIST: GameMode[] = ['5x5', '6x6', '7x7', 'chengyu'];
